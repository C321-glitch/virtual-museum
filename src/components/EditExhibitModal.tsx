...
interface EditExhibitModalProps {
    isOpen: boolean
    onClose: () => void
    onSave: (newNameRu: string, newNameEn: string, newDecriptionRu: string, newDecriptionEn: string, newFile: File | null, newModel: File | null) => Promise<void>
...
export default function EditExhibitModal({
    isOpen,
    onClose,
    onSave,
    initialNameRu,
    ...
    await onSave(nameRu, nameEn, descriptionRu, descriptionEn, selectedFile, selectedModel)
    }
    ...
    <div className="fixed flex items-center justify-center">
        ...
        <div className="font-russo text-[24px] mb-[24px] text-center">Редактировать экспонат</div>
